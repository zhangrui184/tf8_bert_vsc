...
def main(unused_argv):
 ...
 # vocab = Vocab(FLAGS.vocab_path, FLAGS.vocab_size) # create a vocabulary
  vocab=Vocab(os.path.join(FLAGS.bert_path,"vocab.txt"),FLAGS.vocab_size)
  ...
  tokenizer=tokenization.FullTokenizer(os.path.join(FLAGS.bert_path,"vocab.txt"))
  # Create a batcher object that will create minibatches of data
  batcher = Batcher(FLAGS.data_path, vocab, hps, single_pass=FLAGS.single_pass,tokenizer=tokenizer)

  tf.set_random_seed(111) # a seed value for randomness

  if hps.mode == 'train':
    print ("creating model...")
    model = SummarizationModel(hps, vocab,FLAGS.bert_path)
    ...
    model = SummarizationModel(decode_model_hps, vocab,FLAGS.bert_path)
